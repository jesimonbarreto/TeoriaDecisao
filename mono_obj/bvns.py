...
def BVNS(dados, f, k_max, max_int = 5000, plot = False, n_plot = 10, dir_save = './'):
    nfe = 0
    ...
    while(nfe<max_int):
        ...
        if plot and nfe % n_plot == 0:
            ...
            with open(dir_save+'/file_save/vns_'+str(nfe)+'.pkl', 'wb') as handle:
                pickle.dump(save_dic, handle, protocol=pickle.HIGHEST_PROTOCOL)
        
        nfe +=1

    return dados, [y_save, rest3_save, rest4_save, rest5_save, rest6_save, rest7_save, n_ap]
